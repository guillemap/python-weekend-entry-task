    ...
    for flight in json.loads(json.dumps(data)):
        if (
            ...
            or (check_range
                ...
                and (
                    (departure_min is not None and len(departure_min) > 8 and flight["departure"] < departure_min)
        ...
        if flight['origin'] == origin:
            ...
            if (
                ...
                and (
                    ...
                    or (args.trip_duration is not None and travel_time.total_seconds() / 3600 <= args.trip_duration)
                )
            ):
                combinations.append({
